...
export function TourWidget() {
    ...
    return (
        <a className="bit-widget-initializer"
            ...
            data-event-ticket-cta-text-color="rgba(30,41,59,1)"
            data-event-ticket-cta-bg-color="rgba(245,166,35,0)"
            data-event-ticket-cta-border-color="rgba(249,115,22,1)"
            data-event-ticket-cta-border-width="0px"
            data-event-ticket-cta-border-radius="0px"

            data-sold-out-button-text-color="rgba(255,255,255,1)"
            data-sold-out-button-background-color="rgba(30,41,59,1)"
            data-sold-out-button-border-color="rgba(30,41,59,1)"
            ...
            data-play-my-city-cta-border-color="rgba(249,115,22,1)"
