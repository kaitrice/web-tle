...
function Product({ data }: { data: ProductType }) {
  return (
    <div className="w-full flex flex-col md:flex-row items-center justify-center gap-12 px-6 md:px-24 pt-6">
      ...
      <div className="flex flex-col items-center gap-2 md:items-start text-center md:text-left uppercase">
        ...
        <a href={data.url} target="_blank" className="btn px-4 py-2" >
          shop now
        </a>
      </div>
    </div>
